( () => {
    var e = {
            ...
            !function(o, i) {
                ...
                var a = "function"
                        ...
                        for (r = n = 0; r < p.length && !u && p[r]; )
                            if (u = p[r++].exec(e))
                                for (o = 0; o < d.length; o++)
                                    l = u[++n],
                                    typeof (s = d[o]) === c && s.length > 0 ? 2 === s.length ? typeof s[1] == a ? this[s[0]] = s[1].call(this, l) : this[s[0]] = s[1] : 3 === s.length ? typeof s[1] !== a || s[1].exec && s[1].test ? this[s[0]] = l ? l.replace(s[1], s[2]) : i : this[s[0]] = l ? s[1].call(this, l, s[2]) : i : 4 === s.length && (this[s[0]] = l ? s[3].call(this, l.replace(s[1], s[2])) : i) : this[s] = l || i;
                        f += 2
                    }
                }
                  , Y = function(e, t) {
                  ...
                  , Z = {
                    ...
                    cpu: [[/(?:(amd|x(?:(?:86|64)[-_])?|wow|win)64)[;\)]/i], [[m, "amd64"]], [/(ia32(?=;))/i], [[m, G]], [/((?:i[346]|x)86)[;\)]/i], [[m, "ia32"]], [/\b(aarch64|arm(v?8e?l?|_?64))\b/i], [[m, "arm64"]], [/\b(arm(?:v[67])?ht?n?[fl]p?)\b/i], [[m, "armhf"]], [/windows (ce|mobile); ppc;/i], [[m, "arm"]], [/((?:ppc|powerpc)(?:64)?)(?: mac|;|\))/i], [[m, /ower/, "", G]], [/(sun4\w)[;\)]/i], [[m, "sparc"]], [/((?:avr32|ia64(?=;))|68k(?=\))|\barm(?=v(?:[1-7]|[5-7]1)l?|;|eabi)|(?=atmel )avr|(?:irix|mips|sparc)(?:64)?\b|pa-risc)/i], [[m, G]]],
                    device: [[/\b(sch-i[89]0\d|shw-m380s|sm-[ptx]\w{2,4}|gt-[pn]\d{2,4}|sgh-t8[56]9|nexus 10)/i], [f, [b, M], [d, g]], [/\b((?:s[cgp]h|gt|sm)-\w+|sc[g-]?[\d]+a?|galaxy nexus)/i, /samsung[- ]([-\w]+)/i, /sec-(sgh\w+)/i], [f, [b, M], [d, w]], [/(?:\/|\()(ip(?:hone|od)[\w, ]*)(?:\/|;)/i], [f, [b, O], [d, w]], [/\((ipad);[-\w\),; ]+apple/i, /applecoremedia\/[\w\.]+ \((ipad)/i, /\b(ipad)\d\d?,\d\d?[;\]].+ios/i], [f, [b, O], [d, g]], [/(macintosh);/i], [f, [b, O]], [/\b(sh-?[altvz]?\d\d[a-ekm]?)/i], [f, [b, _], [d, w]], [/\b((?:ag[rs][23]?|bah2?|sht?|btv)-a?[lw]\d{2})\b(?!.+d\/s)/i], [f, [b, P], [d, g]], [/(?:huawei|honor)([-\w ]+)[;\)]/i, /\b(nexus 6p|\w{2,4}e?-[atu]?[ln][\dx][012359c][adn]?)\b(?!.+d\/s)/i], [f, [b, P], [d, w]], [/\b(poco[\w ]+|m2\d{3}j\d\d[a-z]{2})(?: bui|\))/i, /\b; (\w+) build\/hm\1/i, /\b(hm[-_ ]?note?[_ ]?(?:\d\w)?) bui/i, /\b(redmi[\-_ ]?(?:note|k)?[\w_ ]+)(?: bui|\))/i, /oid[^\)]+; (m?[12][0-389][01]\w{3,6}[c-y])( bui|; wv|\))/i, /\b(mi[-_ ]?(?:a\d|one|one[_ ]plus|note lte|max|cc)?[_ ]?(?:\d?\w?)[_ ]?(?:plus|se|lite)?)(?: bui|\))/i], [[f, /_/g, " "], [b, B], [d, w]], [/oid[^\)]+; (2\d{4}(283|rpbf)[cgl])( bui|\))/i, /\b(mi[-_ ]?(?:pad)(?:[\w_ ]+))(?: bui|\))/i], [[f, /_/g, " "], [b, B], [d, g]], [/; (\w+) bui.+ oppo/i, /\b(cph[12]\d{3}|p(?:af|c[al]|d\w|e[ar])[mt]\d0|x9007|a101op)\b/i], [f, [b, "OPPO"], [d, w]], [/vivo (\w+)(?: bui|\))/i, /\b(v[12]\d{3}\w?[at])(?: bui|;)/i], [f, [b, "Vivo"], [d, w]], [/\b(rmx[1-3]\d{3})(?: bui|;|\))/i], [f, [b, "Realme"], [d, w]], [/\b(milestone|droid(?:[2-4x]| (?:bionic|x2|pro|razr))?:?( 4g)?)\b[\w ]+build\//i, /\bmot(?:orola)?[- ](\w*)/i, /((?:moto[\w\(\) ]+|xt\d{3,4}|nexus 6)(?= bui|\)))/i], [f, [b, L], [d, w]], [/\b(mz60\d|xoom[2 ]{0,2}) build\//i], [f, [b, L], [d, g]], [/((?=lg)?[vl]k\-?\d{3}) bui| 3\.[-\w; ]{10}lg?-([06cv9]{3,4})/i], [f, [b, A], [d, g]], [/(lm(?:-?f100[nv]?|-[\w\.]+)(?= bui|\))|nexus [45])/i, /\blg[-e;\/ ]+((?!browser|netcast|android tv)\w+)/i, /\blg-?([\d\w]+) bui/i], [f, [b, A], [d, w]], [/(ideatab[-\w ]+)/i, /lenovo ?(s[56]000[-\w]+|tab(?:[\w ]+)|yt[-\d\w]{6}|tb[-\d\w]{6})/i], [f, [b, "Lenovo"], [d, g]], [/(?:maemo|nokia).*(n900|lumia \d+)/i, /nokia[-_ ]?([-\w\.]*)/i], [[f, /_/g, " "], [b, "Nokia"], [d, w]], [/(pixel c)\b/i], [f, [b, N], [d, g]], [/droid.+; (pixel[\daxl ]{0,6})(?: bui|\))/i], [f, [b, N], [d, w]], [/droid.+ (a?\d[0-2]{2}so|[c-g]\d{4}|so[-gl]\w+|xq-a\w[4-7][12])(?= bui|\).+chrome\/(?![1-6]{0,1}\d\.))/i], [f, [b, U], [d, w]], [/sony tablet [ps]/i, /\b(?:sony)?sgp\w+(?: bui|\))/i], [[f, "Xperia Tablet"], [b, U], [d, g]], [/ (kb2005|in20[12]5|be20[12][59])\b/i, /(?:one)?(?:plus)? (a\d0\d\d)(?: b|\))/i], [f, [b, "OnePlus"], [d, w]], [/(alexa)webm/i, /(kf[a-z]{2}wi|aeo[c-r]{2})( bui|\))/i, /(kf[a-z]+)( bui|\)).+silk\//i], [f, [b, k], [d, g]], [/((?:sd|kf)[0349hijorstuw]+)( bui|\)).+silk\//i], [[f, /(.+)/g, "Fire Phone $1"], [b, k], [d, w]], [/(playbook);[-\w\),; ]+(rim)/i], [f, b, [d, g]], [/\b((?:bb[a-f]|st[hv])100-\d)/i, /\(bb10; (\w+)/i], [f, [b, R], [d, w]], [/(?:\b|asus_)(transfo[prime ]{4,10} \w+|eeepc|slider \w+|nexus 7|padfone|p00[cj])/i], [f, [b, E], [d, g]], [/ (z[bes]6[027][012][km][ls]|zenfone \d\w?)\b/i], [f, [b, E], [d, w]], [/(nexus 9)/i], [f, [b, "HTC"], [d, g]], [/(htc)[-;_ ]{1,2}([\w ]+(?=\)| bui)|\w+)/i, /(zte)[- ]([\w ]+?)(?: bui|\/|\))/i, /(alcatel|geeksphone|nexian|panasonic(?!(?:;|\.))|sony(?!-bra))[-_ ]?([-\w]*)/i], [b, [f, /_/g, " "], [d, w]], [/droid.+; ([ab][1-7]-?[0178a]\d\d?)/i], [f, [b, "Acer"], [d, g]], [/droid.+; (m[1-5] note) bui/i, /\bmz-([-\w]{2,})/i], [f, [b, "Meizu"], [d, w]], [/; ((?:power )?armor(?:[\w ]{0,8}))(?: bui|\))/i], [f, [b, "Ulefone"], [d, w]], [/(blackberry|benq|palm(?=\-)|sonyericsson|acer|asus|dell|meizu|motorola|polytron|infinix|tecno)[-_ ]?([-\w]*)/i, /(hp) ([\w ]+\w)/i, /(asus)-?(\w+)/i, /(microsoft); (lumia[\w ]+)/i, /(lenovo)[-_ ]?([-\w]+)/i, /(jolla)/i, /(oppo) ?([\w ]+) bui/i], [b, f, [d, w]], [/(kobo)\s(ereader|touch)/i, /(archos) (gamepad2?)/i, /(hp).+(touchpad(?!.+tablet)|tablet)/i, /(kindle)\/([\w\.]+)/i, /(nook)[\w ]+build\/(\w+)/i, /(dell) (strea[kpr\d ]*[\dko])/i, /(le[- ]+pan)[- ]+(\w{1,9}) bui/i, /(trinity)[- ]*(t\d{3}) bui/i, /(gigaset)[- ]+(q\w{1,9}) bui/i, /(vodafone) ([\w ]+)(?:\)| bui)/i], [b, f, [d, g]], [/(surface duo)/i], [f, [b, C], [d, g]], [/droid [\d\.]+; (fp\du?)(?: b|\))/i], [f, [b, "Fairphone"], [d, w]], [/(u304aa)/i], [f, [b, "AT&T"], [d, w]], [/\bsie-(\w*)/i], [f, [b, "Siemens"], [d, w]], [/\b(rct\w+) b/i], [f, [b, "RCA"], [d, g]], [/\b(venue[\d ]{2,7}) b/i], [f, [b, "Dell"], [d, g]], [/\b(q(?:mv|ta)\w+) b/i], [f, [b, "Verizon"], [d, g]], [/\b(?:barnes[& ]+noble |bn[rt])([\w\+ ]*) b/i], [f, [b, "Barnes & Noble"], [d, g]], [/\b(tm\d{3}\w+) b/i], [f, [b, "NuVision"], [d, g]], [/\b(k88) b/i], [f, [b, "ZTE"], [d, g]], [/\b(nx\d{3}j) b/i], [f, [b, "ZTE"], [d, w]], [/\b(gen\d{3}) b.+49h/i], [f, [b, "Swiss"], [d, w]], [/\b(zur\d{3}) b/i], [f, [b, "Swiss"], [d, g]], [/\b((zeki)?tb.*\b) b/i], [f, [b, "Zeki"], [d, g]], [/\b([yr]\d{2}) b/i, /\b(dragon[- ]+touch |dt)(\w{5}) b/i], [[b, "Dragon Touch"], f, [d, g]], [/\b(ns-?\w{0,9}) b/i], [f, [b, "Insignia"], [d, g]], [/\b((nxa|next)-?\w{0,9}) b/i], [f, [b, "NextBook"], [d, g]], [/\b(xtreme\_)?(v(1[045]|2[015]|[3469]0|7[05])) b/i], [[b, "Voice"], f, [d, w]], [/\b(lvtel\-)?(v1[12]) b/i], [[b, "LvTel"], f, [d, w]], [/\b(ph-1) /i], [f, [b, "Essential"], [d, w]], [/\b(v(100md|700na|7011|917g).*\b) b/i], [f, [b, "Envizen"], [d, g]], [/\b(trio[-\w\. ]+) b/i], [f, [b, "MachSpeed"], [d, g]], [/\btu_(1491) b/i], [f, [b, "Rotor"], [d, g]], [/(shield[\w ]+) b/i], [f, [b, "Nvidia"], [d, g]], [/(sprint) (\w+)/i], [b, f, [d, w]], [/(kin\.[onetw]{3})/i], [[f, /\./g, " "], [b, C], [d, w]], [/droid.+; (cc6666?|et5[16]|mc[239][23]x?|vc8[03]x?)\)/i], [f, [b, F], [d, g]], [/droid.+; (ec30|ps20|tc[2-8]\d[kx])\)/i], [f, [b, F], [d, w]], [/smart-tv.+(samsung)/i], [b, [d, y]], [/hbbtv.+maple;(\d+)/i], [[f, /^/, "SmartTV"], [b, M], [d, y]], [/(nux; netcast.+smarttv|lg (netcast\.tv-201\d|android tv))/i], [[b, A], [d, y]], [/(apple) ?tv/i], [b, [f, O + " TV"], [d, y]], [/crkey/i], [[f, T + "cast"], [b, N], [d, y]], [/droid.+aft(\w+)( bui|\))/i], [f, [b, k], [d, y]], [/\(dtv[\);].+(aquos)/i, /(aquos-tv[\w ]+)\)/i], [f, [b, _], [d, y]], [/(bravia[\w ]+)( bui|\))/i], [f, [b, U], [d, y]], [/(mitv-\w{5}) bui/i], [f, [b, B], [d, y]], [/Hbbtv.*(technisat) (.*);/i], [b, f, [d, y]], [/\b(roku)[\dx]*[\)\/]((?:dvp-)?[\d\.]*)/i, /hbbtv\/\d+\.\d+\.\d+ +\([\w\+ ]*; *([\w\d][^;]*);([^;]*)/i], [[b, H], [f, H], [d, y]], [/\b(android tv|smart[- ]?tv|opera tv|tv; rv:)\b/i], [[d, y]], [/(ouya)/i, /(nintendo) ([wids3utch]+)/i], [b, f, [d, v]], [/droid.+; (shield) bui/i], [f, [b, "Nvidia"], [d, v]], [/(playstation [345portablevi]+)/i], [f, [b, U], [d, v]], [/\b(xbox(?: one)?(?!; xbox))[\); ]/i], [f, [b, C], [d, v]], [/((pebble))app/i], [b, f, [d, x]], [/(watch)(?: ?os[,\/]|\d,\d\/)[\d\.]+/i], [f, [b, O], [d, x]], [/droid.+; (glass) \d/i], [f, [b, N], [d, x]], [/droid.+; (wt63?0{2,3})\)/i], [f, [b, F], [d, x]], [/(quest( 2| pro)?)/i], [f, [b, z], [d, x]], [/(tesla)(?: qtcarbrowser|\/[-\w\.]+)/i], [b, [d, S]], [/(aeobc)\b/i], [f, [b, k], [d, S]], [/droid .+?; ([^;]+?)(?: bui|; wv\)|\) applew).+? mobile safari/i], [f, [d, w]], [/droid .+?; ([^;]+?)(?: bui|\) applew).+?(?! mobile) safari/i], [f, [d, g]], [/\b((tablet|tab)[;\/]|focus\/\d(?!.+mobile))/i], [[d, g]], [/(phone|mobile(?:[;\/]| [ \w\/\.]*safari)|pda(?=.+windows ce))/i], [[d, w]], [/(android[-\w\. ]{0,9});.+buil/i], [f, [b, "Generic"]]],
                  ...
                  , J = function(e, t) {
                    ...
                    this.getOS = function() {
                        ...
                        e[h] = i,
                        X.call(e, n, y.os),
                        x && !e[p] && v && "Unknown" != v.platform && (e[p] = v.platform.replace(/chrome os/i, W).replace(/macos/i, q)),
                        e
                    }
                    ,
        ...
        1639: (e, t, r) => {
            ...
            var n = r(6999)
              ...
              , h = b.prototype;
            e.exports = function(e, t, r) {
                var m, v, w, g, y, x, S, k = r && r.that, O = !(!r || !r.AS_ENTRIES), E = !(!r || !r.IS_RECORD), R = !(!r || !r.IS_ITERATOR), j = !(!r || !r.INTERRUPTED), T = n(t, k), I = function(e) {
                    return m && p(m, "normal", e),
                    new b(!0,e)
                }, N = function(e) {
                    return O ? (i(e),
                    j ? T(e[0], e[1], I) : T(e[0], e[1])) : j ? T(e, I) : T(e)
                };
                if (E)
                    m = e.iterator;
                else if (R)
        ...
        2820: (e, t, r) => {
            "use strict";
            var n, o, i, a = r(2903), s = r(6002), c = r(621), u = r(6426), l = r(6668), f = r(5408), p = r(7258), d = r(482), b = "Object already initialized", h = s.TypeError, m = s.WeakMap;
            if (a || f.state) {
        ...
        3004: (e, t, r) => {
            "use strict";
            var n, o, i, a = r(4492), s = r(4202), c = r(621), u = r(5979), l = r(9972), f = r(679), p = r(9544), d = r(4192), b = p("iterator"), h = !1;
            [].keys && ("next"in (i = [].keys()) ? (o = l(l(i))) !== Object.prototype && (n = o) : h = !0),
            !c(n) || a((function() {
                var e = {};
                return n[b].call(e) !== e
            }
            )) ? n = {} : d && (n = u(n)),
            s(n[b]) || f(n, b, (function() {
                return this
            }
            )),
            e.exports = {
        ...
        3154: (e, t, r) => {
            ...
            d + "" != "a=2" && n(c, "delete", (function(e) {
                ...
                a(t, 1);
                for (var o, s = i(e), c = i(r), d = 0, b = 0, h = !1, m = n.length; d < m; )
                    o = n[d++],
                    h || o.key === s ? (h = !0,
                    l(this, o.key)) : b++;
                for (; b < m; )
        ...
        4952: (e, t, r) => {
            ...
            var n = r(6947)
              ...
              , y = e.exports = function(e, t, r) {
                "Symbol(" === h(d(t), 0, 7) && (t = "[" + m(d(t), /^Symbol\(([^)]*)\).*$/, "$1") + "]"),
                r && r.getter && (t = "get " + t),
                r && r.setter && (t = "set " + t),
                ...
                w && r && a(r, "arity") && e.length !== r.arity && b(e, "length", {
                    value: r.arity
                });
                try {
                ...
                var n = f(e);
                return a(n, "source") || (n.source = v(g, "string" == typeof t ? t : "")),
                e
            }
            ;
        ...
        5979: (e, t, r) => {
            "use strict";
            var n, o = r(960), i = r(8220), a = r(8280), s = r(482), c = r(9936), u = r(3552), l = r(7258), f = "prototype", p = "script", d = l("IE_PROTO"), b = function() {}, h = function(e) {
                return "<" + p + ">" + e + "</" + p + ">"
            }, m = function(e) {
                e.write(h("")),
                e.close();
                ...
                var e, t, r;
                v = "undefined" != typeof document ? document.domain && n ? m(n) : (t = u("iframe"),
                r = "java" + p + ":",
                    ...
                    return {
                        ...
                        parseOpera11: function(r) {
                            return r.stack.split("\n").filter((function(e) {
                                ...
                                var r, n = t.split("@"), o = this.extractLocation(n.pop()), i = n.shift() || "", a = i.replace(/<anonymous function(: (\w+))?>/, "$2").replace(/\([^)]*\)/g, "") || void 0;
        ...
        8963: (e, t, r) => {
            "use strict";
            var n, o, i = r(6002), a = r(8003), s = i.process, c = i.Deno, u = s && s.versions || c && c.version, l = u && u.v8;
        ...
        9731: (e, t, r) => {
            ...
            var n = r(6002)
              ...
              , u = r(1799);
            e.exports = function(e, t) {
                var r, l, f, p, d, b = e.target, h = e.global, m = e.stat;
    ...
    ( () => {
        ...
        const b = "a7f653a7w82d20f99pe720974fm204fcef1"
          , h = "sa7f653a7w82d20f99pe720974fm204fcef1m.js";
        r(3154),
        r(1649),
        r(9604);
        let m = function(e) {
          ...
          , O = {
            ...
            notify: (e, t) => {
                try {
                    ...
                    if (o.browserTarget === v.NotAvailable || o.browserTarget === v.Unknown || o.surface === m.NotAvailable || o.surface === m.Unknown || !E(o.shopUrl))
                    ...
                    const a = function(t, {userAgent: r, context: n, severity: o, unhandled: i, library: a, hashVersionSandbox: s, sandboxUrl: c, pixelId: u, pixelType: l, runtimeContext: f, shopId: p, initConfig: d, notes: h, surface: m, shopDomain: v, browserTarget: w, shopUrl: g}) {
                        const {device: y, os: x, browser: k, engine: O} = function(t) {
                            try {
                      ...
                      , s = w.has("ac843a20") ? "https://error-analytics-production.shopifysvc.com" : "https://notify.bugsnag.com";
                    if (!s)
                        return void console?.log("Bugsnag notify:", a);
                    fetch(s, {
                        method: "POST",
                        headers: {
        ...
        const I = e => "number" == typeof e ? new T(e) : new Map
          , N = (...e) => JSON.stringify(e);
        function P(e, {cache: t, cacheKey: r}={}) {
            function n(...t) {
                const o = n.cache
                  , i = (r ?? N).apply(this, t);
                if (o.has(i))
                ...
                j(document, "cookie", {
                    ...
                    set: function(t) {
                        const o = t.split(";").map((e => e.trim())).find((e => e.startsWith("domain=")))
                          , i = o?.split("=")[1] || "";
                        if (r.find((e => new RegExp(`^\\.?${e}$`).test(i))))
                            return;
                        const a = n.getValue();
                        n.update(( () => e.browser.cookie.set(t)), ( () => function(e, t) {
                            ...
                            return i[n] = o,
                            Object.keys(i).map((e => i[e] ? `${e}=${i[e]}` : e)).join("; ")
                        }(a, t)))
                    },
                    configurable: !1,
                    enumerable: !1
        ...
        function B(e) {
            const t = new URL(e);
            if ("https:" !== t.protocol)
                throw new _(`URL must be secure (HTTPS): ${t.href}`);
            if (/^\/api\/.+\/graphql\.json$/.test(t.pathname))
                return t;
            const r = M.host.replace(/[/\-\\^$*+?.()|[\]{}]/g, "\\$&");
            if (new RegExp(`^${M.protocol}//(.*@)?${r}`,"i").test(t.href))
                throw new U(`Requests are not allowed to the same origin: ${t.href}`);
            return t
        }
        const F = Function.prototype.call.bind(XMLHttpRequest.prototype.open);
        r(2341);
        const z = ["constructor", "hasOwnProperty", "toString", "toLocaleString", "valueOf", "isPrototypeOf", "propertyIsEnumerable", "__defineGetter__", "__defineSetter__", "__lookupGetter__", "__lookupSetter__", "__proto__", "apply", "call", "bind"];
        function W(e, t) {
        ...
        let J = !1;
        const Q = async e => {
            const {pageTitle: t, webPixelConfig: r, shopId: n, webPixelApi: o} = e
              , i = o.init.context;
            if (J) {
                const e = new X;
                throw O.notify(e, {
        ...
        ( () => {
            try {
                            ...
                            case 0:
                                {
                                    ...
                                    try {
                                        ...
                                        const {name: e, message: t, stack: o} = r;
                                        throw d(1, [n, {
                                            name: e,
                                            message: t,
                                            stack: o
                            ...
                            case 5:
                                {
                                    ...
                                    try {
                                        ...
                                        const {name: t, message: n, stack: o} = r;
                                        throw d(6, [e, {
                                            name: t,
                                            message: n,
                                            stack: o
                ...
                )(Y ? self : function({targetOrigin: e="*"}={}) {
            ...
            !function(e, t=self) {
                ...
                e || (r.addEventListener = function(e) {
                    let t = !1;
                    return (r, n, o) => (t || (console.warn("In a sandboxed environment, addEventListener may not behave as expected."),
                    t = !0),
                    e(r, n, o))
                }(t.addEventListener)),
                $(t, r),
...
importScripts('/wpm/strict/app/web-pixel-shopify-app-pixel@0420.js');
